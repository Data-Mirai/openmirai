...
Open-source agent execution engine compiled in Rust. Runs agentic workflows defined as YAML graphs. One binary, any LLM, 52 built-in tools, 7 LLM providers, 906 tests. Alternative to LangGraph, CrewAI, and Google ADK. Version: v0.7.0.
